...
namespace TBT.App.Helpers
{
    public class RefreshEvents
    {
        ...
        public static async Task<ObservableCollection<User>> RefreshUsersList()
        {
            ...
            return data != null ? new ObservableCollection<User>(JsonConvert.DeserializeObject<ObservableCollection<User>>(data).OrderBy(x=>x.IsBlocked).ThenBy(x => x.FullName)) : new ObservableCollection<User>();
        }
        ...
        { 
            ...
            return data != null ? new ObservableCollection<Customer>(JsonConvert.DeserializeObject<ObservableCollection<Customer>>(data).OrderBy(x=>x.Name)) : new ObservableCollection<Customer>();
        }
        ...
        public static async Task<ObservableCollection<Project>> RefreshProjectsList()
        {
            ...
            return data != null ? new ObservableCollection<Project>(JsonConvert.DeserializeObject<ObservableCollection<Project>>(data).OrderBy(x=>x.Name)): new ObservableCollection<Project>();
        }
